 ...
 * abriendo o aÃ±adiendo las ventanas/Jpanel necesarias para que el administrador navegue
...
public class ControladorAdmin  implements ActionListener,KeyListener,MouseListener{
	 ...
	 * @param ax VentanaAdminPrincipal a la que se le ejercerÃ¡ el control
	 */
	 ...
	 * @param a Formulario al que se ejercerÃ¡ un control
	 */
 ...
 */
	...
	/**
	 * Metodo auxiliar encargado de obtener el Nombre de todos los tecnicos junto con su contraseÃ±a
